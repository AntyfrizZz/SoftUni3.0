namespace SimpleMVC.App.MVC.Routers
{
    ...
    public class ControllerRouter
    {
        ...
        public void ParseInput()
        {
            ...
            this.RetrieveGetParameters();

            string postParameters = WebUtility.UrlDecode(this.request.Content);
            this.RetrivePostParameters(postParameters);
        ...
        private void RetrivePostParameters(string postParameters)
        {
        ...
        private void RetrieveGetParameters()
        {
        ...
        {
            var controllerType = $"{MvcContext.Current.AssemblyName}.{MvcContext.Current.ControllersFolder}.{this.controllerName}";

            return (Controller)Activator.CreateInstance(Type.GetType(controllerType));
        }
